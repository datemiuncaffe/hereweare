angular
	.module('riepiloghi')
	.controller('OreMeseController', ['$scope', '$state', 'NgTableParams', 'crud', 'resourceBaseUrlBackend',
		function($scope, $state, NgTableParams, crud, resourceBaseUrlBackend) {
			...
			ref.tableParams = new NgTableParams({
				...
				getData: function(params) {
					...
					return crud.GET.EHOUR.getOreLavUtenteMese(params.url()).then(function(data) {
						var res = [];
