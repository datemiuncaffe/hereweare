angular
	.module('riepiloghi')
	.controller('giorniCommessaUtenteWithCommentsController', ['$scope', '$state', 'NgTableParams', 'crud', 'resourceBaseUrlBackend',
          ...
          console.log('params.group(): ' +
            JSON.stringify(params.group(), null, '\t'));*/
					...
					return crud.GET.EHOUR
						.getGiorniCommessaUtenteWithComments(params.url()).then(function(data) {
							var res = [];
							if (data != null &&
