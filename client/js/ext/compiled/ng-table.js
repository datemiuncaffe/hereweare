...
var NgTableParams = (function () {
    ...
    NgTableParams.prototype.group = function (group, sortDirection) {
		 //console.log('NGTABLE NgTableParams.prototype.group: ' + group);
        if (group === undefined) {
    ...
    NgTableParams.prototype.parseGroup = function (group) {
		 //console.log('NGTABLE parseGroup');
        var defaultSort = this._settings.groupOptions.defaultSort;
        if (!group) {
			  //console.log('NGTABLE parseGroup not group: ' + group);
            return group;
        }
            ...
            if (group.sortDirection == null) {
				...
				//console.log('NGTABLE parseGroup fun group: ' + group);
            return group;
        }
            ...
            for (var key in group) {
				...
				//console.log('NGTABLE parseGroup obj group: ' + group);
            return group;
        }
        else {
            return _a = {},
...
var NgTableGroupRowController = (function () {
    function NgTableGroupRowController($scope) {
        ...
        $scope.$watch('params.group()', function (newGrouping) {
			  //console.log('NGTABLE newGrouping: ' + newGrouping);
    ...
    NgTableGroupRowController.prototype.getVisibleColumns = function () {
		 //console.log('NGTABLE getVisibleColumns');
        var _this = this;
    ...
    NgTableGroupRowController.prototype.groupBy = function (group) {
		 //console.log('NGTABLE group: ' + JSON.stringify(group,null,'\t'));
		 //console.log('NGTABLE group groupable: ' + group.groupable);
        if (this.isSelectedGroup(group)) {
            ...
            if (this.isGroupingFunc(group)) {
                ...
                // columns that return (truthy) strings
					 //console.log('NGTABLE groupable: ' + group.groupable(this.$scope));
    ...
    NgTableGroupRowController.prototype.setGroup = function (grouping) {
		//  console.log('NGTABLE setGroup grouping: ' +
		//  	JSON.stringify(grouping, null, '\t'));
        ...
        if (this.isGroupingFunc(grouping)) {
            ...
            var groupKey = Object.keys(grouping || {})[0];
				//console.log('NGTABLE setGroup groupKey: ' + groupKey);
            ...
            if (groupedColumn) {
                ...
                this.$scope.$selGroup = groupKey;
					 //console.log('NGTABLE setGroup $selGroup: ' + this.$scope.$selGroup);
                if (groupedColumn.show.assign) {
						 //console.log('NGTABLE show.assign FALSE');
